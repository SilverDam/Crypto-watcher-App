...
class CoinLatestDetailScreen extends StatefulWidget {
  final LatestDataModel coinLatest;
  const CoinLatestDetailScreen({
    required this.coinLatest,
  });

  @override
  State<CoinLatestDetailScreen> createState() => _CoinLatestDetailScreenState();
}

class _CoinLatestDetailScreenState extends State<CoinLatestDetailScreen> {
  @override
