class AirdropStatusModel {
 ...
 AirdropStatusModel(this.timestamp, this.errorCode, this.errorMessage, this.elapsed,
      this.creditCount, this.notice, this.totalCount);



      AirdropStatusModel.fromJson(Map<String, dynamic> json) 
