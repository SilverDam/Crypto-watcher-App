class NewCoinStatusModel {
 ...
 NewCoinStatusModel(this.timestamp, this.errorCode, this.errorMessage, this.elapsed,
      this.creditCount, this.notice, this.totalCount);



      NewCoinStatusModel.fromJson(Map<String, dynamic> json)
